...
extern String currentFwVersion;
extern bool channelsSynced;
extern bool logicSynced;
extern bool fwChecked;
...
/**
 * @brief Saves the current firmware version to non-volatile storage (Preferences).
 *       Should be called after a successful OTA update.
 * @param version The firmware version string to save (e.g., "1.2.3").
 */
void saveFirmwareVersion(const String &version);

/**
 * @brief Loads the firmware version from non-volatile storage (Preferences).
 */
